...
export default function ProPage() {
  ...
  useEffect(() => { const saved = (localStorage.getItem("fixmy_pro_locale") as UiLocale | null) ?? "es"; setLocale(saved === "fr" || saved === "nl" || saved === "en" || saved === "pt" ? saved : "es"); }, []);
  useEffect(() => { localStorage.setItem("fixmy_pro_locale", locale); return localizeDocument(locale); }, [locale]);
