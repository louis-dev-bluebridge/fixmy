...
@Module({
  ...
  providers: [AppService, PaymentsService, CredentialVaultService, ActivityService, SystemLogService, JobGateway, PrismaService, { provide: APP_GUARD, useClass: AuthGuard }],
})
